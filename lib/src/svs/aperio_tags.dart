...
/// only ever use [newJpeg] — everything else there is rejected immediately
/// (see `SvsFile._fromTiff`). Associated images (thumbnail/label/macro) may
/// legitimately use any of these; [oldJpeg] and unlisted values are not
/// decodable by this package (no pure-Dart old-style-JPEG or JPEG2000
/// decoder exists) and are reported clearly rather than guessed at.
