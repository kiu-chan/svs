...
void main() {
  test('decodes a real Aperio JP2K tile matching an independent (Pillow) oracle within CPU-rounding tolerance', () {
    ...
    expect(maxDiff, lessThanOrEqualTo(1), reason: 'diverges from the oracle by more than expected CPU-rounding noise');
    expect(mismatchCount, lessThanOrEqualTo(32), reason: 'too many differing bytes to be just rounding noise');
  });
